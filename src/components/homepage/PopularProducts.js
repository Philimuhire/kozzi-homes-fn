...
const PopularProducts = () => {
  ...
  const mockProducts = [
    { id: 1, name: "Rose Bouquet", category: "Flowers", price: "10,000", image: require("../../images/12.jpg") },
    { id: 2, name: "Tulip Arrangement", category: "Flowers", price: "12,000", image: require("../../images/12.jpg") },
    { id: 3, name: "Orchid Basket", category: "Flowers", price: "15,000", image: require("../../images/12.jpg") },
    { id: 1, name: "Rose Bouquet", category: "Flowers", price: "10,000", image: require("../../images/12.jpg") },
    { id: 2, name: "Tulip Arrangement", category: "Flowers", price: "12,000", image: require("../../images/12.jpg") },
    { id: 3, name: "Orchid Basket", category: "Flowers", price: "15,000", image: require("../../images/12.jpg") },
    { id: 1, name: "Rose Bouquet", category: "Flowers", price: "10,000", image: require("../../images/12.jpg") },
        ...
        {displayProducts.map((product) => (
          <div key={product.id} className="rounded-lg shadow-md p-4">
            <img
              src={product.image}
              alt={product.name}
              className="w-full h-48 sm:h-36 md:h-48 object-contain mb-4"
            />
